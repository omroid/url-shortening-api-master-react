        ...
        return (
            ...
            <footer>
                <div className="row footerRow">
                    ...
                    <div className="col-sm-2 linksDiv">
                        <h6>Resources</h6>
                        <ul>
                            <li><a href="#">Blog</a></li>
                    ...
                    <div className="col-sm-3 linksDiv">
                        <div className="iconsDiv">
                          <a href="#"> <div className="icon facebook" src="images/icon-facebook.svg" > </div> </a>
                            <a href="#"> <div className="icon twitter" src="./images/icon-twitter.svg" ></div></a>
                            <a href="#">  <div className="icon pinterest" src="./images/icon-pinterest.svg" ></div></a>
                            <a href="#">  <div className="icon instagram" src="./images/icon-instagram.svg" ></div></a>
                        </div>
                    </div>
                    <div className="col">
                        <div className="attribution">
                            Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank">Frontend Mentor</a>.
                        Coded by <a href="https://github.com/omroid/">Omroid</a>.
                    </div>
                    </div>
                </div>
            </footer>
